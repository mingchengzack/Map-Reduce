...
../mrsequential ../../mrapps/wc.so ../files/pg*txt || exit 1
sort mr-out-0 > mr-correct-wc.txt
rm -f mr-out*

echo '***' Starting wc test.

timeout -k 2s 180s ../mrmaster ../files/pg*txt &
...
# generate the correct output
../mrsequential ../../mrapps/indexer.so ../files/pg*txt || exit 1
...
# generate the correct output
../mrsequential ../../mrapps/nocrash.so ../files/pg*txt || exit 1
...
rm -f mr-done
(timeout -k 2s 180s ../mrmaster ../files/pg*txt ; touch mr-done ) &
sleep 1
...
# clean up files
rm -rf ../mr-tmp
rm ../mrsequential ../mrmaster ../mrworker
rm ../../mrapps/*.so
